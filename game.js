...
const CHARACTERS = {
    good: [
        ...
        },
        {
            ...
            questions: {
                "你怀了孕，怎么还独身一人出来行走？": ["你是如何看出……！好吧，我同夫君约定在前头的丰禾村碰面。"],
            ...
            reactions: {
                accept: ["贵客走进房门，他本应坐在一旁备好被褥的空床位上休整，却走向你慎重其事地道谢，你看见他脸色苍白，行动不便，并且动作之间还露出微鼓的幅度。你心头一软，连忙扶起他的同时，还在心里埋怨那个不知身在何处的丈夫。"],
                reject: ["挺拔的身影伸出手轻轻伏在门框处，你借着破损的窗口看到他脑袋抵着门急促的喘息着，", "“……”过了一会，你听到门口的脚步声渐渐远了。"]
            },
            items: [
                {
                    name: "同心玉佩",
                ...
                {
                    name: "绣花粗劣的荷包",
                    desc: "这荷包上的花纹扭曲，勉强可以看出绣的是鸳鸯，但是……怎么两只都是色彩鲜艳的雄雄鸟？不过这荷包鼓鼓囊囊，可见他并不缺钱。"
                },
                {
                    name: "布巾",
