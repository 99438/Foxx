...
const CHARACTERS = {
    good: [
        ...
        {
            identity: "白衣公子",
            appearance: ["看起来是一位白衣公子，耳边夹一朵素白玉楼春，玄发如瀑，竟不沾染一丝泥灰。"],
            questions: {
                "你身上为何没有灰尘？": ["（他意味深长一笑，却没有回答。）"],
                "我如何取信于你？": ["用这玉楼春为誓，少侠可还中意？"],},
            greetings: [
                "少侠，更深露重，外头苦寒湿重，可否请少侠开开门帮我一忙呀？"
            ],
            reactions: {
                accept: ["白衣公子把耳边的玉楼春折下递进你手中，衣袂飘飖间带起一股冷香，他并没过多叨扰你，只看着你盈盈笑说：“这算作我给少侠的谢礼罢。”"],
                reject: ["门外人眨着眼微怔片刻，语气沉沉又略带委屈：少侠怎的不信我呀……"]
            },
            outcomes: [
            ],
            items: [
    ...
    bad: [
        ...
        {
            identity: "奇装异服的人",
            appearance: ["来人的头发利索地削短了，但是穿着甚为奇怪，皱着清秀的眉，然后从衣服口袋里拿出了一块……砖头？还会发光？"],
            questions: {
                "你手上拿的是什么？": ["嗯……（门口的人沉默了片刻，似乎在思考如何解释作答）呃…用于飞鸽传书的东西。"],
                "你到底是什么人？": ["我……（门口的人似乎是有些无语，又或者是不知道如何作答，吱了一声就没了下文。）","和你一样的公民……不，百姓。"],},
            greetings: [
                "（小声）啧……怎么没信号？真穿越了？你好，有人在吗？"
            ],
            reactions: {
                accept: ["开门对上视线的时候，这怪人眉头一挑，少年疑惑地望过去，这怪人又飞快移开了视线“抱歉……仔细一看，你长得很像一个人。"],
                reject: ["“……真是见鬼，早知道不去看那场电影了。”门口的人似乎没有停留，捏着那块会发光的砖头很快离开了。"]
            },
            outcomes: [
                "……少年度过了可以说是非常迷幻的一晚，被那个奇装异服的人拉着用那块闪着光的砖头“拍”了好几下！那人“拍”完后又念叨了几句“还真是一模一样”、“真是无奇不有……”之类奇怪的话。那个东西会吸人的魂魄吗！早知道不放他进来了！！"
            ],
            items: [
                {
                    name: "会发光的砖头",
                    desc: "那是什么东西……为什么一边摆弄砖头一边念叨“没信号”？新号是什么东西？他想传递消息？"
                },
                {
                    name: "两张皱皱的小纸片",
                    desc: "花里胡哨的两张小纸片，在衣袋里有些发皱。写着一些什么字……看不太明白。"
                },
                {
                    name: "发绳",
                    desc: "套在手腕上的……发绳吗？不过主人的短发让人怀疑这东西是否另有他用。"
                },
                {
                    name: "戒指",
                    desc: "普通的戒指，戴在来人的中指上。"
