...
const CHARACTERS = {
    good: [
        ...
        },
        {
            ...
            reactions: {
                ...
                reject: ["你…你会后悔的…武将无力地锤打了门板后伴随着驴蹄声渐行渐远，你打开一条门缝看到一地血迹有些后悔…"]
            },
            items: [
                {
                    name: "玉佩",
    ...
    bad: [
        ...
        },
        {
            ...
            reactions: {
                accept: ["贵客走进房门，坐在一旁备好被褥的空床位上休整，你看见他脸色苍白，行动不便，脱下披风露出丰腴的身姿以及他肚子上鼓胀的幅度。"],
                reject: ["挺拔的身影愣了愣，四指成拳紧握了一会儿，随即卸力放松。", "“……”过了一会，你听到门口的脚步声渐渐远了。"]
            },
            items: [
                {
                    name: "同心玉佩",
                ...
                {
                    name: "装着东西的玉瓶",
                    desc: "一件漂亮的瓷瓶，封口用蜡封得十分完好，你闻不到里面的气味。"
                },
                {
                    name: "绣花粗劣的荷包",
                    desc: "这荷包上的花纹扭曲，勉强可以看出绣的是鸳鸯，但是……怎么两只都是色彩鲜艳的雄鸟？不过这荷包鼓鼓囊囊，可见他并不缺钱。"
